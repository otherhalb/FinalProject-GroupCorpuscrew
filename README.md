...
Install required packages:
    pip install pandas numpy nltk emoji langdetect vaderSentiment scikit-learn gensim wordcloud seaborn matplotlib torch transformers==4.41.0 sentence-transformers==2.6.1 umap-learn hdbscan bertopic
